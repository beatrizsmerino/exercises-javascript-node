...
function getVerifyWinter(month) {
    if (month <= 2 || month >= 11) {
        console.log("Estamos en el mes " + month + "." + "Es invierno.");
        return true;
    } else {
        console.log("Estamos en el mes " + month + "." + "No es invierno.");
        return false;
    }
}
...
function getVerifyWeekend(day) {
    if (day === 6 || day === 7) {
        console.log("Estamos en el dia " + day + "." + "Es finde semana.");
        return true;
    } else {
        console.log("Estamos en el dia " + day + "." + "No es invierno.");
        return false;
    }
}
...
function discount() {
    ...
    if (initProcess) {
        ...
        if (resultVerifyWinter) {
            ...
            var verifyDay = getVerifyWeekend(day);
            if (verifyDay) {
                ...
                // Calcular descuento
                var calcDiscount = calcDiscount(discount, price);
                alert("Precio final con el descuento del " + discount + "%" + " es de " + calcDiscount + "€");
            } else {
